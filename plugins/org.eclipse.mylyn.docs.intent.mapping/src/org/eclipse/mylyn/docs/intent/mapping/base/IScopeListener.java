...
public interface IScopeListener {
	...
	public static class Stub implements IScopeListener {
		 ...
		 * {@inheritDoc}
		 *
		 * @see org.eclipse.mylyn.docs.intent.mapping.base.IScopeListener#holderChanged(java.lang.String)
		 */
		 ...
		 * {@inheritDoc}
		 *
		 * @see org.eclipse.mylyn.docs.intent.mapping.base.IScopeListener#locationAdded(org.eclipse.mylyn.docs.intent.mapping.base.ILocation)
		 */
		 ...
		 * {@inheritDoc}
		 *
		 * @see org.eclipse.mylyn.docs.intent.mapping.base.IScopeListener#locationRemoved(org.eclipse.mylyn.docs.intent.mapping.base.ILocation)
		 */
