 ...
 * @generated
 */
public class JenaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JenaPackage.RDF_LOCATION: {
				RdfLocation rdfLocation = (RdfLocation)theEObject;
				T result = caseRdfLocation(rdfLocation);
				if (result == null)
					result = caseLocation(rdfLocation);
				if (result == null)
					result = caseIEMFBaseElement(rdfLocation);
				if (result == null)
					result = caseLocationContainer(rdfLocation);
				if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rdf Location</em>'. <!--
	 * begin-user-doc --> This implementation returns null; returning a non-null result will terminate the
	 * switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *            the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rdf Location</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRdfLocation(RdfLocation object) {
		return null;
	}
