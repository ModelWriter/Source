...
public class IdePackageImpl extends EPackageImpl implements IdePackage {
	 ...
	 * @generated
	 */
	public EReference getEObjectFileLocation_SavedURIFragments() {
		return (EReference)eObjectFileLocationEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(eObjectFileLocationEClass, EOBJECT_FILE_LOCATION__SAVED_URI_FRAGMENTS);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getEObjectFileLocation_SavedURIFragments(), theMappingPackage.getCouple(), null,
				"savedURIFragments", null, 0, -1, EObjectFileLocation.class, !IS_TRANSIENT, !IS_VOLATILE,
