 ...
 * <ul>
 * <li>{@link anydsl.impl.FoodImpl#getName <em>Name</em>}</li>
 * <li>{@link anydsl.impl.FoodImpl#getColor <em>Color</em>}</li>
 * <li>{@link anydsl.impl.FoodImpl#getCaliber <em>Caliber</em>}</li>
 * <li>{@link anydsl.impl.FoodImpl#getRelatedFoods <em>Related Foods</em>}</li>
 * <li>{@link anydsl.impl.FoodImpl#getGroup <em>Group</em>}</li>
 * <li>{@link anydsl.impl.FoodImpl#getLabel <em>Label</em>}</li>
 * <li>{@link anydsl.impl.FoodImpl#getSource <em>Source</em>}</li>
 * <li>{@link anydsl.impl.FoodImpl#getProducers <em>Producers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
