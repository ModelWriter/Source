...
import org.eclipse.mylyn.docs.intent.mapping.ide.tests.resource.AbstractTextFileLocationTests;
import org.eclipse.mylyn.docs.intent.mapping.tests.base.IBaseFactory;

/**
 * Tests {@link org.eclipse.mylyn.docs.intent.mapping.ide.TextFileLocation TextFileLocation}.
 *
...
public class EMFTextFileLocationTests extends AbstractTextFileLocationTests {
	...
	public EMFTextFileLocationTests() {
		factory = new Factory() {
